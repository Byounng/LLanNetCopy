...
parser.add_argument('-mode', choices=['server', 'client'],default="client", help='Run mode: server or client.')
parser.add_argument('-action', choices=['send', 'receive'], default="send", help='Action: send or receive.')
parser.add_argument('-ip', type=str,default="127.0.0.1", help='IP address of the peer (required for client mode).')
parser.add_argument('-path', type=str,default=r"E:\newwwww\datasets_data\medmnist", help='File path or directory to send (required for send action).')
